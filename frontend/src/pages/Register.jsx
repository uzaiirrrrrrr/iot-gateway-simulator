...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!emailValid) return setError('Please enter a valid Gmail address (e.g. operator@gmail.com).');
  ...
  return (
    <div className="flex min-h-screen bg-[#020617] overflow-hidden font-outfit">
      ...
      >
        <div className="absolute inset-0">
          ...
          <motion.div 
            ...
            className="absolute top-1/4 right-1/4 w-64 h-64 bg-fuchsia-600/30 blur-[120px] rounded-full"
          />
        </div>
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl text-slate-400 max-w-md mx-auto leading-relaxed font-light">
      ...
      <motion.div 
        ...
        className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#020617]"
      >
        <div className="max-w-md w-full relative">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-bold text-white mb-3">Register Node</h2>
            <p className="text-slate-500 text-lg">Join the unified simulator infrastructure</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-900/50 border ${emailValid === false ? 'border-red-500/40' : 'border-slate-800'} text-white rounded-2xl pl-14 pr-14 py-4 outline-none focus:border-purple-500/50 transition-all focus:ring-4 focus:ring-purple-500/5`}
                  required
                />
                {emailValid === true && (
                    <div className="absolute inset-y-0 right-0 pr-5 flex items-center pointer-events-none">
                        <CheckCircle2 size={18} className="text-purple-400 shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                    </div>
                )}
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-slate-900/50 border border-slate-800 text-white rounded-2xl pl-14 px-5 py-4 outline-none focus:border-purple-500/50 transition-all focus:ring-4 focus:ring-purple-500/5"
                  required
                />
              </div>
              {password && (
                <div className="mt-4 px-1">
                    <div className="flex justify-between mb-2">
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Strength: <span className="text-white">{strength.label}</span></span>
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                  <Fingerprint size={18} className="text-slate-600 group-focus-within:text-purple-400 transition-colors" />
                </div>
                <select
                  value={role}
                  onChange={(e) => setRole(e.target.value)}
                  className="w-full bg-slate-900/50 border border-slate-800 text-white rounded-2xl pl-14 px-5 py-4 outline-none focus:border-purple-500/50 transition-all focus:ring-4 focus:ring-purple-500/5 appearance-none cursor-pointer"
                >
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-5 rounded-2xl shadow-xl shadow-purple-900/20 transition-all flex items-center justify-center gap-4 disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="mt-10 text-center text-sm text-slate-500">
            Already registered?{' '}
            <Link to="/login" className="text-purple-400 hover:text-purple-300 transition-colors font-bold tracking-tight">

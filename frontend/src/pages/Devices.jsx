...
import {
    ...
    Settings, Info, Database, Zap, ArrowRight, MousePointer2, Terminal, RefreshCcw
} from 'lucide-react';
...
const GatewayDropZone = ({ gateway, children, isOver }) => {
    ...
    return (
        <div
            ref={setNodeRef}
            className={`relative transition-all duration-300 rounded-2xl ${isOver ? 'ring-4 ring-blue-500 ring-offset-4 scale-[1.02] bg-blue-50/50' : ''
        ...
        try {
            ...
            const latestLogs = devRes.data
                ...
                .map(d => ({
                    ...
                    deviceId: d.id,
                    deviceName: d.name,
                    payload: d.last_payload || `[SYS_PULSE] Status: OK | Buffer: Optimal`,
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 px-4 py-2 rounded-xl flex items-center gap-2 transition-all font-bold text-sm shadow-sm"
                            title="Refresh Data"
                        >
                                            ...
                                            <DraggableDevice key={dev.id} device={dev}>
                                                ...
                                                >
                                                    ...
                                                    <div className="mt-3 flex items-center justify-between">
                                                        ...
                                                        <div className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-widest ${dev.type === 'Sensor' ? 'bg-blue-100 text-blue-600' :

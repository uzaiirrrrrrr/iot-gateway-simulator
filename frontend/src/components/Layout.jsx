  ...
  return (
    <div className="flex h-screen bg-slate-100 overflow-hidden font-outfit">
      ...
      <div className="w-64 bg-[#0a0c1a] text-white flex flex-col flex-shrink-0 border-r border-slate-800/50">
        <div className="p-4 text-xl font-bold border-b border-slate-800/50 flex items-center gap-3">
        ...
        <div className="p-4 border-t border-slate-800/50 bg-[#0a0c1a]">
          {/* Encryption Badge */}
          <div className="mb-4 p-3 bg-purple-500/5 rounded-2xl border border-purple-500/10 backdrop-blur-sm">
              <div className="text-[9px] uppercase tracking-[0.2em] text-purple-400 font-bold mb-1.5">Encryption Active</div>
          ...
          <div className="mb-4 px-1">
            <div className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mb-1.5">Operator Identity</div>
            <div className="font-bold text-slate-200 truncate text-sm mb-1.5">{user?.email}</div>
          ...
          <div className="space-y-1.5">
            <button 
                ...
                className="flex items-center gap-3 text-slate-500 hover:text-red-400 transition-all w-full px-3 py-2 rounded-xl hover:bg-red-500/10 group text-sm font-bold"
            >
            ...
            <button 
                ...
                className="flex items-center gap-3 text-slate-600 hover:text-amber-500 transition-all w-full px-3 py-2 rounded-xl hover:bg-amber-500/10 group text-sm font-bold"
            >
